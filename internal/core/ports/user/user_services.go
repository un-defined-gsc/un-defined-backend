...
type IUsersService interface {
	Login(ctx context.Context, login domains.LoginDTO) (sess *domains.SessionDTO, err error)
	...
	MFAToggle(ctx context.Context, userUUID uuid.UUID) (status bool, err error)
	GetMFA(ctx context.Context, userUUID uuid.UUID) (mfa *user_domain.MFASetting, err error)
	GetMe(ctx context.Context, userUUID uuid.UUID) (user *user_domain.User, err error)
